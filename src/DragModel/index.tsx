...
class DragModel extends React.Component<any, any> {
    ...
    changVal = (L: any, T: any) => {
        this.props.postion && this.props.postion({
            left: L,
            top: T
        });
    ...
    render() {
        ...
        const { children, wrapClassName, title, noneFooter, isModals, ...other } = this.props;
                ...
                <div id="div1" style={style}>
                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            ...
                            <span className="header-close" onClick={() => this.props.onCancle()}>×</span>
                        </div>
                        <div className="modal-body">
                            {children}
                        </div>
                        {
                            !noneFooter ? <div className="modal-footer">
                                <Button onClick={() => this.props.onCancle()}>取消</Button>
                                <Button type="primary" style={{ marginLeft: '8px' }} onClick={() => this.props.onOk()}>确定</Button>
                            </div> : ''
                        }
                    </div>
                </div>
                {
                    isModals ? <div className="models">
                    </div> : ''
                }
            </div>

...
var onClick = function onClick(e) {
  ...
  var goToFmath = function goToFmath() {
    window.open('http://www.fmath.info', '_blank');
  };

  var getMathML = function getMathML() {
    var index = getIndexForElementId(elementId);
    displayMessage(formulasList[index].getMathMLString("ENTITIES", true));
  };

  var getLatex = function getLatex() {
    var index = getIndexForElementId(elementId);
  ...
  var zoomIn100 = function zoomIn100() {
    var index = getIndexForElementId(elementId);
  ...
  var zoomOut100 = function zoomOut100() {
    var index = getIndexForElementId(elementId);
    canvasScaleList[index] = canvasScaleList[index] / 2;
    formulasList[index].scaleFormula(canvasScaleList[index]);
  };

  var zoom100 = function zoom100() {
    var index = getIndexForElementId(elementId);

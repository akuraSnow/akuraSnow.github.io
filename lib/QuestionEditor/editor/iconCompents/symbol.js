...
var SymbolIcon = function SymbolIcon(props) {
  ...
  function insertIcon(value) {
    ...
    if (value.type !== 'mention') {
      _slate.Transforms.insertText(editor, value.text);
    } else if (selection && selection.focus && selection.focus.path.length !== 3) {
      _slate.Transforms.insertNodes(editor, value);
    ...
    } else if (selection && selection.focus && selection.focus.path.length === 3 && _slate.Node.parent(editor, selection.anchor.path).ListItem) {
      _slate.Transforms.insertNodes(editor, value); // let selection = props.editor.selection;
      ...
      _slate.Transforms.setSelection(editor, _newPositiong);
    }
  }
  ...
  }, _toolbarIcon.symbol)), /*#__PURE__*/_react.default.createElement("div", null, visible && props.isFocuse ? /*#__PURE__*/_react.default.createElement(_index.default, {
    style: {
      width: '400px',
      height: '412px',
      backgroundColor: '#fff',
  ...
  }, _lodash.default.map((0, _client.symbolList)(), function (symbolItem, index) {
    return /*#__PURE__*/_react.default.createElement(TabPane, {
      tab: symbolItem.label,
      key: index
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: "symbolContent"
    }, _lodash.default.map(symbolItem.content, function (contentItem, i) {
      var str = null;

      if (contentItem.fontSize) {
        str = /*#__PURE__*/_react.default.createElement("span", {
          style: {
            fontSize: "".concat(contentItem.fontSize, "px")
          }
        }, unescape(contentItem.text));
      } else if (contentItem.type === 'mention') {
        str = /*#__PURE__*/_react.default.createElement("img", {

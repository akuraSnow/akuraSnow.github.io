...
initMathjaxConfig(); // import { Tips } from './../MessageTips/index/index';
...
var formatQuestion = /*#__PURE__*/function () {
  ...
  _createClass(formatQuestion, [{
    ...
    value: function formatStem(e) {
      ...
      _.map(stem, function (stemItem, key) {
        if (!stemItem['NumberedList']) {
          ...
          if (stemItem['NumberedList'] === 'None') {
            ...
            _.map(stemItem.children, function (stemItem, key) {
              stemContent += '<li>';
              stemContent += that.getString(stemItem, key);
              stemContent += '</li>';
            });
    ...
    value: function getString(stemItem, key) {
      ...
      var innerStyle = _.filter(blockStyleList1, function (item) {
...
export { formatQuestion as default };
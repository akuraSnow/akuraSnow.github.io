...
import { identifyFormulaFromImage } from '../../services/EditdQuestion'; // import { Tips } from '../../index';
...
var InsertFormula = function InsertFormula(props) {
  ...
  var _useState7 = useState(null),
      ...
      identifyResult = _useState8[0],
      setIdentifyResult = _useState8[1];
  ...
  var _useState13 = useState(false),
      ...
      isParseInput = _useState14[0],
      setIsParseInput = _useState14[1];

  var parseImgRef = useRef();
  ...
  useEffect(function () {
    ...
    setModalPosition(props.modalPosition); // setVisible(props.modalPosition.visible);
  }, [props.modalPosition]);
  useEffect(function () {
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.prev = 2;
                            _context.next = 5;
                            return identifyFormulaFromImage({
                              image: blob
                            });
  ...
  }, insertFormula, /*#__PURE__*/React.createElement("span", {
    className: "title",
    style: {
      width: "100px",
      height: '20px',
  ...
  }, !previewImage ? /*#__PURE__*/React.createElement("span", null, "\u8BF7\u5C06\u56FE\u7247\u7C98\u8D34\u5230\u6B64\u5904") : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      left: 20,
      top: 40,
  ...
  }, "\u8BC6\u522B\u7ED3\u679C"), /*#__PURE__*/React.createElement("div", {
    style: {
      paddingTop: 32
    },

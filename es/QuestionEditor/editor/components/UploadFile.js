...
import fileExtension from 'file-extension'; // import { Tips, message } from './../../index';

import { Tips } from '../../../MessageTips/index';
import { postSignatures // 获取签名
, updateFile } from '../../services/EditdQuestion';
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _context.next = 8;
              return postSignatures(sendData);
